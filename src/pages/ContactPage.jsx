          ...
          >
            ...
            >
              ...
              <Text
                ...
                mb="24px"
              >
                Give us a few details about your device or issue and we&apos;ll
                get back to you.
              </Text>
              ...
              <VStack align="stretch" gap="15px">
                ...
                <Box>
                  <Text fontSize="12px" fontWeight="700" color={navy} mb="6px">
                    Phone
                  </Text>
        ...
        <Container maxW="1160px" px={{ base: 4, md: 5 }}>
          <Box textAlign="center" maxW="650px" mx="auto" mb="30px">
            ...
            <Text color="#607086" fontSize="14px" lineHeight="1.7" mt="10px">
              Conveniently located in Brantford. Get directions and visit us for
              your computer repair and technology needs.
            </Text>
          </Box>
      ...
      <Box bg={navy} color="white" py={{ base: "50px", md: "65px" }}>
        <Container maxW="850px" px={{ base: 4, md: 5 }} textAlign="center">
          ...
          >
            ...
            computer. Tell us what you&apos;re experiencing and we&apos;ll help
