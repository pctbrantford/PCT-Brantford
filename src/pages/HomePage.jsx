          ...
          >
            <Box>
              ...
              <Text fontSize="18px" color="#b7c6d7" maxW="610px">
                Reliable computer repair, laptop repair, upgrades, data recovery
                and custom PC services — backed by 30+ years of local
                experience.
              </Text>
              <Stack
          ...
          >
            ...
            <Box>
              ...
              <Text color="#607086" mt="20px">
                {businessInfo.name} has served the Brantford community for more
                than 30 years. The goal is simple: provide reliable, affordable
                and timely computer repair without making customers feel lost in
                technical jargon.
              </Text>
                ...
                >
                  ...
                  >
                    ...
                    <Text
                      ...
                      fontSize="54px"
                      color={color}
                      textShadow={image ? "0 2px 14px rgba(0,0,0,.6)" : "none"}
          ...
          >
            ...
            <Box>
              ...
              <Text
                ...
                mt="15px"
              >
                Tech support should feel straightforward: understand the issue,
                know your options, and get back to work.
              </Text>
      ...
      >
       <VStack alignContent={"center"} justify={"center"}>
         <Container maxW="1160px" px={{ base: 4, md: 5 }}>
          ...
          >
            <Box>
              <Eyebrow light>Let&apos;s fix it</Eyebrow>
              <Heading
              ...
              <Text color="#9eb0c2" mt="15px">
                Send a repair request and the team can follow up with next
                steps. For urgent questions, call the shop directly.
              </Text>
            ...
            >
              ...
              <Button type="submit" {...buttonStyle}>
                Request a Repair <span>→</span>
              </Button>
              <Text fontSize="10px" color="#8290a0" mt="10px">
                Demo form: connect this to Wix Forms, Formspree, Netlify Forms
                or your preferred backend before launch.
              </Text>
              {submitted && (
                <Box
                  mt="12px"
                  ...
                  fontSize="12px"
                >
                  Thanks! Your request has been captured in this demo. Connect
                  the form to your preferred email/backend to receive
                  submissions.
                </Box>
              )}
            </Box>
