...
export default function AboutPage() {
  ...
  return (
    <>
      {/* SEO Section */}
      <SEO
        title="About PCT | Computer Repair Brantford"
        description="Learn about Personal Computer Terminal, a trusted computer repair and IT services business serving Brantford, Ontario."
        canonical="/about"
      />
      <Box>
        {/* Hero Section */}
            ...
            >
              <Box>
                ...
                >
                  ...
                  repaired, and upgraded whenever it makes practical and
                  financial sense. Our experienced bench technicians handle
                  complex component-level repairs — from broken charging DC
                  jacks, cracked LCDs, and liquid spill corrosion to power
                  circuit soldering and emergency data recovery.
                </Text>
                ...
                >
                  ...
                  immense pride in greeting our neighbors with clear
                  explanations, upfront pricing, and zero confusing technical
                  jargon.
                </Text>
